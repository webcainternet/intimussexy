    ...
    $.ajax({
        ...
        success: function(json) {
            ...
            if (json['redirect']) {
                ...
                $('#collapse-checkout-option .panel-body').prepend('<div class="alert alert-danger"><i class="material-design-cancel19"></i> ' + json['error']['warning'] + '<button type="button" class="close material-design-close47" data-dismiss="alert"></button></div>');
        ...
        success: function(json) {
            ...
            if (json['redirect']) {
                ...
                if (json['error']['warning']) {
                    $('#collapse-payment-address .panel-body').prepend('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error']['warning'] + '<button type="button" class="close material-design-close47" data-dismiss="alert"></button></div>');
                }
    ...
    $.ajax({
        ...
        success: function(json) {
            ...
            if (json['redirect']) {
                ...
                if (json['error']['warning']) {
                    $('#collapse-payment-address .panel-body').prepend('<div class="alert alert-warning"><i class="material-design-warning37"></i> ' + json['error']['warning'] + '<button type="button" class="close material-design-close47" data-dismiss="alert"></button></div>');
                }
    ...
    $.ajax({
        ...
        success: function(json) {
            ...
            if (json['redirect']) {
                ...
                if (json['error']['warning']) {
                    $('#collapse-shipping-address .panel-body').prepend('<div class="alert alert-warning"><i class="material-design-warning37"></i> ' + json['error']['warning'] + '<button type="button" class="close material-design-close47" data-dismiss="alert"></button></div>');
                }
    ...
    $.ajax({
        ...
        success: function(json) {
            ...
            if (json['redirect']) {
                ...
                if (json['error']['warning']) {
                    $('#collapse-shipping-method .panel-body').prepend('<div class="alert alert-warning"><i class="material-design-warning37"></i> ' + json['error']['warning'] + '<button type="button" class="close material-design-close47" data-dismiss="alert"></button></div>');
                }           
            } else {
                $.ajax({
                    url: 'index.php?route=checkout/payment_method',
    ...
    $.ajax({
        ...
        success: function(json) {
            ...
            if (json['redirect']) {
                ...
                if (json['error']['warning']) {
                    $('#collapse-payment-method .panel-body').prepend('<div class="alert alert-warning"><i class="material-design-warning37"></i> ' + json['error']['warning'] + '<button type="button" class="close material-design-close47" data-dismiss="alert"></button></div>');
                }           
            } else {
                $.ajax({
