...
<div id="cart" class="cart toggle-wrap">
	<button type="button" data-loading-text="<?php echo $text_loading; ?>" class="toggle item-btn">
	...
	<li>
	  <div>
		...
		<div class="text-right">
			...
			<a class="cart-remove-btn" href="<?php echo $checkout; ?>"><span ><?php echo $text_checkout; ?></span></a></p>
	  </div>
	</li>
	<?php } else { ?>
	<li>
