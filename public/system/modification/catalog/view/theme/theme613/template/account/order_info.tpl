          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-right" style="white-space: nowrap;"><?php if ($product['reorder']) { ?>
                <a href="<?php echo $product['reorder']; ?>" data-toggle="tooltip" title="<?php echo $button_reorder; ?>" class="cart-remove-btn"><i class="material-design-shopping232"></i></a>
                <?php } ?>
                <a href="<?php echo $product['return']; ?>" data-toggle="tooltip" title="<?php echo $button_return; ?>" class="cart-remove-btn"><i class="material-design-back57"></i></a></td>
            </tr>
            <?php } ?>
